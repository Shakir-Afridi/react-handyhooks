/**
 * @hook useIndexedDB
 * @description A React hook for interacting with IndexedDB in the browser.
 * Provides a simple interface to open a database and perform basic operations
 ...
 * } | null} - Object containing the database and helper methods, or null if not initialized.
 *
 * @example
